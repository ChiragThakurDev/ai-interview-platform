...
class AdminService:
    ...
    def get_dashboard_summary(self):
        average_score = (
            self.repository.get_average_score() or 0
        )
    ...
    def get_recent_activity(self):
        return {
            "recent_users": self.repository.get_recent_users(),
            "recent_interviews": self.repository.get_recent_interviews(),
    ...
    def search_users(
        ...
        users, total = self.repository.search_users(
            search=search,
            skip=skip,
            limit=limit,
        )
    ...
    def get_analytics(self):
        return {
            "registrations": self.repository.get_registration_stats(),
            "interviews": self.repository.get_interview_stats(),
            "popular_roles": self.repository.get_popular_roles(),
            "difficulty_distribution": self.repository.get_difficulty_distribution(),
